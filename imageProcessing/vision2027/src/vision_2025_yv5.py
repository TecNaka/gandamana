...
class ball_detection:
    ...
    def get_hsv_val111(self, img):
        ...
        hsv_val[0] = [nilai_hsv_tengah, nilai_hsv_sepertiga_kanan,nilai_hsv_duapertiga_kanan,nilai_hsv_sepertiga_kiri,nilai_hsv_duapertiga_kiri,nilai_hsv_bawah_tengah]
        hsv_val[1] = [satu_nilai_hsv_tengah, satu_nilai_hsv_sepertiga_kanan,satu_nilai_hsv_duapertiga_kanan,satu_nilai_hsv_sepertiga_kiri,satu_nilai_hsv_duapertiga_kiri,satu_nilai_hsv_bawah_tengah]
        hsv_val[2] = [dua_nilai_hsv_tengah, dua_nilai_hsv_sepertiga_kanan,dua_nilai_hsv_duapertiga_kanan,dua_nilai_hsv_sepertiga_kiri,dua_nilai_hsv_duapertiga_kiri,satu_nilai_hsv_bawah_tengah]
